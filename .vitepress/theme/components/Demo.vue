...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<span class="token title"># Σελίδα 2</span><br><br>', { delay: 400 })
    .type('- 📄 Δημιουργήστε διαφάνειες σε ένα ενιαίο αρχείο Markdown<br>', { delay: 800 })
    .type('- 🌈 Θέματα, κομμάτια κώδικα, διαδραστικά components<br>', { delay: 800 })
    .type('- 😎 Διαβάστε τις οδηγίες για να μάθετε περισσότερα!', { delay: 800 })
